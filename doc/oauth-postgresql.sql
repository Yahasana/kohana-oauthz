...
COMMENT ON COLUMN "t_oauth_authorizes".expired_date IS 'date time';
...
/******************** Add Table: "t_oauth_clients" ************************/
 CREATE SEQUENCE seq_t_oauth_clients_server_id INCREMENT 1;
...
/* Set Comments */
COMMENT ON COLUMN "t_oauth_tokens".token_type IS 'bearer';
