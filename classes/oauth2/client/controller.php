 ...
 * *
 */
class Oauth2_Client_Controller extends Kohana_Controller {
    ...
    public function action_code($uri = NULL, $type = NULL)
    {
        ...
        $this->request->redirect($uri.'?'.Oauth2::build_query($params));
    }
    ...
    public function action_do()
    {
        ...
        try
        {
            ...
            $token = Remote::get($this->_configs['token_uri'],array(
                ...
                CURLOPT_POSTFIELDS  => Oauth2::build_query(array(
