 ...
 * *
 */
abstract class Oauth2_Server_Controller extends Kohana_Controller {
    ...
    public function before()
    {
        ...
        Oauth2_Exception::$errors[$this->_type]['code_errors'] = $this->_configs['code_errors'];
        Oauth2_Exception::$errors[$this->_type]['token_errors'] = $this->_configs['token_errors'];
        Oauth2_Exception::$errors[$this->_type]['access_errors'] = $this->_configs['access_errors'];
    }
    ...
    {
        $parameter = new Oauth2_Parameter_Code($this->_configs['code_params']);

        $token = new Model_Oauth2_Token;
        ...
        if($code_token = $token->code($parameter->client_id))
        {
            ...
            // Populate the code
            $response = $parameter->oauth2_token($code_token);
        }
        else
        {
            // Invalid client_id
            $e = new Oauth2_Exception_Authorize('invalid_client');
    ...
    protected function token()
    {
        ...
        $parameter = new Oauth2_Parameter_Token($params);
    ...
    {
        $parameter = new Oauth2_Parameter_Webserver($this->_configs['grant_params']['authorization_code']);
    ...
    {
        $parameter = new Oauth2_Parameter_Autonomous;

        $server = new Model_Oauth2_Server;
    ...
    {
        $parameter = new Oauth2_Parameter_Assertion;
    ...
    {
        $parameter = new Oauth2_Parameter_Refresh;
    ...
    {
        $parameter = new Oauth2_Parameter_None;
