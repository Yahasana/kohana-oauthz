...
if($authorized) 
{
    $redirect_uri = Oauthy::parse_query($query, 'redirect_uri');
    ?>do you want to let the <strong><?php echo $redirect_uri; ?></strong> to access your information?
    <br /><br /><a href="<?php echo Oauthy::grant_access_uri('http://docs/oauth/authorize'); ?>" title="">Approve access</a>
    <a href="<?php echo Oauthy::access_denied_uri(); ?>" title="">Deny access</a><?php 
} 
else 
{ 
